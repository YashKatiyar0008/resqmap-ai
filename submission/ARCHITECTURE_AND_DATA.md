...
- Offline behavior: prototype session cache and report queue
- Hosting: Vercel and connected Sites deployment

## Data labels

- **LIVE:** reported by a connected external feed
...
If a source fails, ResQMap keeps the last verified warning visible and identifies the source as cached instead of exposing a technical error to citizens.
